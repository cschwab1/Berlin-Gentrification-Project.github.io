...
#### Merging all rasters into a single dataframe. 
...
bdataC <- bdata_whole %>% 
  dplyr::select(x, unempC, longunempC, gWelfareC, seniorC, foreignC, euC, brwPriceC) %>%
  na.omit()
```
...
```{r}
save(bdataC, file="~/Desktop/Code/Thesis/bdataC.rda")
```
