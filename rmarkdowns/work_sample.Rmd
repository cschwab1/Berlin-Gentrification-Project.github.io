...
and, finally, the slightly more involved process of average price per area, which requires a more involved process of interpolation via kriging: 

```{r}
##### Functions required to download spatial data: 
...
##### setting up raster for interpolation 
